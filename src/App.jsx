    ...
    <>
      <div className="header">
        <div style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 14 }} onClick={restart}>
          <svg width="36" height="40" viewBox="0 0 36 44" xmlns="http://www.w3.org/2000/svg">
            <polyline points="2,42 18,6 34,42" fill="none" stroke="#c9a84c" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round"/>
            <polyline points="9,42 18,20 27,42" fill="none" stroke="#c9a84c" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.3"/>
          </svg>
          <div>
